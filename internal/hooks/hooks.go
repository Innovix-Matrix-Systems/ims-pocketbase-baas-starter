...
func RegisterHooks(app *pocketbase.PocketBase) {
	app.Logger().Info("Registering custom event hooks")
	...
	app.Logger().Info("Custom event hooks registration completed")
}
...
func registerCollectionHooks(app *pocketbase.PocketBase) {
	...
	app.Logger().Debug("Collection hooks registered")
}
...
func registerRequestHooks(app *pocketbase.PocketBase) {
	...
	app.Logger().Debug("Request hooks registered")
}
...
func registerRealtimeHooks(app *pocketbase.PocketBase) {
	...
	app.Logger().Debug("Realtime hooks registered")
}
